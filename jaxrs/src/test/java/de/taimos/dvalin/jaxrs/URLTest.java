...
class URLTest {
    ...
    private void assertSplit(String url, String scheme, String host, String port, String path) {
        ...
        Assertions.assertEquals(scheme, split.getScheme());
        Assertions.assertEquals(host, split.getHost());
        Assertions.assertEquals(port, split.getPort());
        Assertions.assertEquals(path, split.getPath());
    }
