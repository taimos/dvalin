 ...
 * @author psigloch
 */
public class FindIVOModel extends AbstractFindModel {

    protected static final String VM = "ivo/find.vm";
     ...
     */
    public FindIVOModel(IVODef definition, Log logger, IAdditionalMemberHandler... additionalMemberHandlers) {
    ...
    protected Collection<GenerationContext> getInnerGenerationContexts() {
        ...
        if (Boolean.TRUE.equals(this.definition.getGenerateFilter())) {
            result.add(new GenerationContext(FindIVOModel.VM, this.getFileName(FindIVOModel.TYPE, false), false));
        }
        return result;
    }
    ...
    protected void beforeChildHandling() {
        ...
        if (this.hasParentClazz()) {
            this.imports.add(this.definition.getParentFilterPkgName() + "." + this.getParentFilterClazzName(false));
            ...
            this.imports.add(AbstractIVO.class);
    ...
    private String getParentFilterClazzName(boolean isInterface) {
        return (isInterface ? "I" : "") + "Find" + this.definition.getParentName() + FindIVOModel.TYPE + this.definition.getParentVersion();
    }
}
