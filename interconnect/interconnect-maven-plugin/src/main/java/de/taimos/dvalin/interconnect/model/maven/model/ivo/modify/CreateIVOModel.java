 ...
 * @author psigloch
 */
public class CreateIVOModel extends AModifyModel {
     ...
     */
    public CreateIVOModel(IVODef definition, Log logger, IAdditionalMemberHandler... additionalMemberHandlers) {
    ...
    protected Collection<GenerationContext> getInnerGenerationContexts() {
        ...
        if (Boolean.TRUE.equals(this.definition.getGenerateCreate())) {
            result.add(new GenerationContext(CreateIVOModel.VM_INTERFACE, this.getFileName("Create", true), true));
            result.add(new GenerationContext(CreateIVOModel.VM, this.getFileName("Create", false), false));
        }
        return result;
    }
}
