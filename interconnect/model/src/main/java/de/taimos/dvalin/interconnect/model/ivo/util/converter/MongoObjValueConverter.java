 ...
 * @author psigloch
 */
public class MongoObjValueConverter implements IValueConverter {

    @Override
    public <Destination> Object convert(Object originalFieldValue, Destination target, Field originalField, Field targetField) {
        Class clazz;
        try {
            clazz = Class.forName("de.cinovo.datastore.mongo.IEntity");
        } catch(ClassNotFoundException e) {
            return null;
        }
        if(clazz != null && clazz.isInstance(originalFieldValue)) {
